 ...
 * {@link JingPagerAdapter} to generate the pages that the view shows.
 *
 ...
 */
public class JingViewPager extends ViewGroup {
    ...
    private JingPagerAdapter mAdapter;
    private int mCurItem;   // Index of currently displayed page.
    private int mRestoredCurItem = -1;
    private Parcelable mRestoredAdapterState = null;
    private ClassLoader mRestoredClassLoader = null;
    private Scroller mScroller;
    private JingPagerAdapter.DataSetObserver mObserver;
    ...
    public interface OnPageChangeListener {
         ...
         * @see JingViewPager#SCROLL_STATE_IDLE
         * @see JingViewPager#SCROLL_STATE_DRAGGING
         * @see JingViewPager#SCROLL_STATE_SETTLING
         */
    ...
    public JingViewPager(Context context) {
        super(context);
        initViewPager();
    }

    public JingViewPager(Context context, AttributeSet attrs) {
        super(context, attrs);
        initViewPager();
    }
	...
	public void setAdapter(JingPagerAdapter adapter) {
        if (mAdapter != null) {
    ...
    public JingPagerAdapter getAdapter() {
        return mAdapter;
    }
    ...
    void setCurrentItemInternal(int item, boolean smoothScroll, boolean always, float velocity) {
     ...
     */
    void smoothScrollTo(int x, int y, float velocity) {
        if (getChildCount() == 0) {
            // Nothing to do.
            setScrollingCacheEnabled(false);
            return;
    ...
    void dataSetChanged() {
        ...
        for (int i = 0; i < mItems.size(); i++) {
            ...
            if (newPos == JingPagerAdapter.POSITION_UNCHANGED) {
                continue;
            }

            if (newPos == JingPagerAdapter.POSITION_NONE) {
                mItems.remove(i);
                i--;
                mAdapter.destroyItem(this, ii.position, ii.object);
                needPopulate = true;
...
//        	return false;
    ...
    private class DataSetObserver implements JingPagerAdapter.DataSetObserver {
        @Override
    ...
    public void setCurrentItem(int item, float velocity) {
		mPopulatePending = false;
