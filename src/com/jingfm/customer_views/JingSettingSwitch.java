 ...
 * 
 */
public class JingSettingSwitch extends CompoundButton {
	 ...
	 */
	public JingSettingSwitch(Context context) {
		this(context, null);
	 ...
	 *            styling.
	 */
	public JingSettingSwitch(Context context, AttributeSet attrs) {
	 ...
	 */
	public JingSettingSwitch(Context context, AttributeSet attrs, int defStyle) {
		...
		thumbXoffset = JingTools.dip2px(context, 0.5f);
	}
	...
	public void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
		...
		mThumbWidth = Math.max(maxTextWidth + mThumbTextPadding * 2,
				mTrackDrawable.getIntrinsicWidth() / 2);
		switch (widthMode) {
	...
	private boolean hitThumb(float x, float y) {
		...
		final int thumbLeft = mSwitchLeft + (int) (mThumbPosition + thumbXoffset)
				- mTouchSlop;
	...
	protected void onLayout(boolean changed, int left, int top, int right,
		...
		mThumbPosition = isChecked() ? getThumbScrollRange() : thumbXoffset;
	...
	protected void onDraw(Canvas canvas) {
		...
		mThumbDrawable.getPadding(mTempRect);
		final int thumbPos = (int) (mThumbPosition + thumbXoffset);
		int thumbLeft = switchInnerLeft - mTempRect.left + thumbPos;
		int thumbRight = switchInnerLeft + thumbPos + mThumbWidth
				+ mTempRect.right;
		if (thumbLeft < 10) {
			// thumbLeft = thumbLeft - 1 ;
			if (thumbRight - thumbLeft < mThumbWidth / 2) {
				thumbRight = mThumbWidth / 2 + thumbLeft + 2;
			} else {
				thumbRight = thumbRight + 2;
			}

		}
		if (thumbRight > (mThumbWidth - 10)) {
			thumbLeft = thumbLeft - 2;
			// thumbRight = thumbRight + 1;
		}
