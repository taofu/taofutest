...
public abstract class AssertHelper {
	...
	public static void doesNotContain(String textToSearch, String substring, String message) {
		if (StringHelper.isNotEmpty(textToSearch) && StringHelper.isNotEmpty(substring) && textToSearch.indexOf(substring) != -1) {
			throw new IllegalArgumentException(message);
		}
	...
	public static void doesNotContain(String textToSearch, String substring, RuntimeException throwIfAssertFail) {
		if (StringHelper.isNotEmpty(textToSearch) && StringHelper.isNotEmpty(substring)
	...
	public static void notEmpty(Collection<?> collection, String message) {
		if (CollectionsHelper.isEmpty(collection)) {
			throw new IllegalArgumentException(message);
		}
	}
